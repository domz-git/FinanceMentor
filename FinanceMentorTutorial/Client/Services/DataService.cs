    ...
    public class DataService:IDataService
    {
        ...
        public async Task<ThreeMonthsData> LoadLast3MonthsEarnings()
        {
            ...
            return new ThreeMonthsData
            {
                ...
                {
                    Data = await GetMonthlyEarnings(previuosMonth.Month, previuosMonth.Year),
                    Label = GetMonthAsText(previuosMonth.Month, previuosMonth.Year)
                }
            };
        }
        public async Task<ThreeMonthsData> LoadLast3MonthsExpenses()
        {
            ...
            return new ThreeMonthsData
            {
                ...
                PreviousMonth = new MonthlyData
                {
                    Data = await GetMonthlyExpenses(previuosMonth.Month, previuosMonth.Year),
                    Label = GetMonthAsText(previuosMonth.Month, previuosMonth.Year)
                }
            };
        }
